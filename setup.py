...
URL = 'https://github.com/garovent/mva'

LICENSE = 'Apache License 2.0'
DESCRIPTION = 'A package to correct the bias of forecasts/hindcasts. Read the documentation at https://github.com/garovent/mva'
